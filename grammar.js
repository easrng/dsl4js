...
var grammar = {
    ...
    {"name": "namedblock", "symbols": ["namedblock$ebnf$1", "safename", "namedblock$ebnf$2", "block"], "postprocess": d=>([d[1].value, d[3]])},
    ...
    {"name": "call", "symbols": ["safename", "call$ebnf$1", "BEGIN_CALL", "arguments", "END_CALL", "call$ebnf$2"], "postprocess": b=>({type:"call",name:b[0].value, blocks:(b[5]&&b[5][1])?b[5][1].value:{}, arguments:b[3]?b[3].value:[]})},
